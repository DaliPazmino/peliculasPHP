                  ...
                  //Proceso de creacion de tabla y relleno de datos de la BDD
                    if ($result->num_rows > 0) {
                      ...
                      while($row = $result->fetch_assoc()) {
                        ...
                        echo '<th scope="row">
                        <a class="text-success" href="update.php?apl_id='.$row["apl_id"].'"><button class="border border-0 rounded-top">
                        <img src="../../img/lapiz.png" ></a>
                        <a href="view.php?apl_id='.$row["apl_id"].'"><button class="border border-0 rounded-top">
                        <img src="../../img/buscando.png"></a>
                        <a class="text-danger" href="delete.php?apl_id='.$row["apl_id"].'"><button class="border border-0 rounded-top">
